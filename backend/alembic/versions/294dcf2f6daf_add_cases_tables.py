...
Revision ID: 294dcf2f6daf
Revises: 8f7d190fbb54
Create Date: 2026-09-16 20:44:48.960725
...
revision: str = '294dcf2f6daf'
down_revision: Union[str, None] = '8f7d190fbb54'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_case_tags_id'), 'case_tags', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_case_tags_id'), table_name='case_tags')
