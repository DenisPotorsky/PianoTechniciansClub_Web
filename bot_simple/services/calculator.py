...
class StringCalculator:
    """Сервис расчета струн (Correct Physics Edition)"""
    RHO_COPPER = 0.00896  # г/мм³

    @staticmethod
    def calculate(winding_type: str, core: float, total: float,
                  length: float, ratio: float = 2.5, allowance: float = 60.0) -> Dict[str, Any]:
